...
data_id = paste("2020_07_08", params$sample_fraction, params$hlen, params$extra_id, sep="_")

fit_id = paste("2020_07_08", params$sample_fraction, params$hlen, params$extra_id, sep="_")
...
if (create_datasets_bool) {
  ...
  lst <- create_datasets(data, datadir, dumpdir, data_id, sample_fraction, hlen=params$hlen, 
...
data.male <- filter_based_on_number_of_donations(data.male, params$hlen)
data.female <- filter_based_on_number_of_donations(data.female, params$hlen)

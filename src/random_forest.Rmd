...
saveRDS(train, file="../output/train.rds")
saveRDS(validate, file="../output/validate.rds")
...
rrfFit_roc <- caret::train(x = train %>% select(-Hb_deferral), y = train %>% pull(Hb_deferral),
                           method = "ranger", 
...
if (use_pdf) {     
  ...
  res <- compute_shap_values(rrfFit_roc$finalModel, train, validate, variables)

...
# dir.create(rawresultdir, recursive = TRUE, showWarnings = FALSE)
...
#caret::confusionMatrix(reference=validate$Hb_deferral, data=prediction_vl, positive = "Deferred")
#caret::confusionMatrix(reference=validate$Hb_deferral, data=prediction_vl, positive = "Deferred", mode = "prec_recall")

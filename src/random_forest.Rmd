...
if (sample_fraction != 1.0)
  data <- data %>% slice_sample(prop = sample_fraction)
...
save(train_orig, file="/tmp/pre-enriched.rdata")
...
save(enriched, file="/tmp/post-enriched.rdata")
...
save(enriched, file="/tmp/enriched.rdata")
#enriched <- enriched %>% select(-FERRITIN_LAST_DATE)
#rm(train_orig)
test <- data[-a,] # %>% select(-FERRITIN_LAST_DATE)
message("and here")
```

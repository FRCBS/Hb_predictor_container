...
train <- additional_preprocess(train_orig, c(variables, "label"), logger=logger)    # Label is needed if we will learn hyperparameters.

#Validate

validate <- additional_preprocess(test, c(variables, "Hb", "sex"), logger=logger) # We want to include Hb and sex to the prediction result table

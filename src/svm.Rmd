...
train <- additional_preprocess(train_orig, c(variables, "label"))    # Label is needed if we will learn hyperparameters.
...
if (use_pdf) {     
  ...
  res <- compute_shap_values_shapr(svmFit_roc, validate, variables, seed=global_random_seed) 
